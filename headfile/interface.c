...
proto_parser_t parsers[7]={
	...
	{mysql_is_sql, mysql_is_login, mysql_is_logout, mysql_is_response,
	 com_query, mysql_get_risk, mysql_get_risk2, NULL, NULL, mysql_response, mysql_get_from_login, &mysql_buffer},
	/*sqlserver*/
	{sqlserver_is_sql, sqlserver_is_login, sqlserver_is_logout, sqlserver_is_response,
	 sqlserver_sql, sqlserver_get_risk, sqlserver_get_risk2, NULL, NULL, sqlserver_response, sqlserver_get_from_login, &sqlserver_buffer},
	/*oracle*/
	{oracle_is_sql, oracle_is_login, oracle_is_logout, oracle_is_response,
	 oracle_sql, oracle_get_risk, oracle_get_risk2, NULL, NULL, oracle_response, oracle_get_from_login, &oracle_buffer},
	/*postgre*/
	{pg_is_sql, pg_is_login, pg_is_logout, pg_is_response,
	 pg_query, pg_get_risk, NULL, NULL, NULL, pg_response, NULL, &postgres_buffer},
	/*sybase*/
	{sybase_is_sql, sybase_is_login, sybase_is_logout, NULL,
	 sybase_sql, sybase_get_risk, NULL, NULL, NULL, sybase_response, NULL, &sybase_buffer},
	/*db2*/
	{/*NULL,NULL,NULL,NULL,
	 db2_sql,NULL,NULL,NULL, NULL, db2_response, NULL, &db2_buffer*/},
	/*shentong*/
	{shentong_is_sql, shentong_is_login, shentong_is_logout, NULL,
	 shentong_sql, shentong_get_risk, NULL, NULL, NULL, shentong_response, NULL, &shentong_buffer}
};
		    ...
		    u_char *buf_pack, int alllen, int bad_visit, int if_custom)
{
	...
	if(dir==1){
		if(parser.is_sql!=NULL && parser.is_sql(payload)){//sql语句
			...
			/*从登录报文中获取用户名,库名，客户端类型*/
			parser.get_from_login(payload,dst_ip,dst_port);
